...
$adr_lcid = "en-US"
$adr_exectype = "msi"
$adr_followuri = 'https://dl.google.com/tag/s/dl/chrome/install/googlechromestandaloneenterprise64.msi'
$adr_absoluteuri = 'https://dl.google.com/tag/s/dl/chrome/install/googlechromestandaloneenterprise64.msi'  # $null if not known
